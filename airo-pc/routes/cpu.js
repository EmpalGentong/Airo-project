...
import { allcpu, cpuid, cpumanufacturer, getProductByType, gamerCPU, kuliCPU, entryLevelCPU, midLevelCPU, highEndCPU, inputCPU, updateCPU, deleteCPU } from "../controllers/cpuBin.js"
...
router.get('/model/:model', getProductByType);
